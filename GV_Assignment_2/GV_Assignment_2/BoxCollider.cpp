...
{
    return (m_max.x > secondBox.m_min.x && secondBox.m_max.x > m_min.x &&   //x dimension of surrounding box for collision
            m_max.y > secondBox.m_min.y && secondBox.m_max.y > m_min.y);   //y dimension -||-
}
